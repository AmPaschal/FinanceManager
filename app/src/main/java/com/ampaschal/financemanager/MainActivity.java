...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        financeDatabase = FinanceDatabase.getInstance(MainActivity.this);

        ArrayList<FinanceEntity> list = (ArrayList)financeDatabase.getFinanceDao().getAll();

        if (list.size() > 0){
            Log.d("Finance Database", list.get(0).getDateString() + list.get(0).getPurpose());
        }
